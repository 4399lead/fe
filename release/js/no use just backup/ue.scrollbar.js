...
(function($, window, undefined){
	...
	ctor.prototype = {
		init : function(){
			...
			options.btn.unbind("mousedown.scrollbar").bind("mousedown.scrollbar",function(e){
			...
			$([window,document.body]).bind("mouseup.scrollbar", function(){
				if(_this.isMouseDown){
					_this.isMouseDown = false;
					document.body.onselectstart = function(){return true};
					return false;
				}
			}).bind("mousemove.scrollbar", function(e){
				if(_this.isMouseDown){
					_this.updatePosition(e);
					return false;
				}
