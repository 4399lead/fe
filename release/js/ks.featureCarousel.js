    ...
    $.fn.featureCarousel = function (options) {
        ...
        return $(this).each(function () {
            ...
            var pluginData = {
                ...
                totalFeatureCount:      $(this).children(options.itemTag).length,
            ...
            function setupFeatureDimensions() {
                ...
                var $firstFeatureImage = $(pluginData.containerIDTag).find("img:first");
            ...
            function setupCarousel() {
                ...
                pluginData.featuresContainer.children(options.itemTag).each(function (index) {
                ...
                if (pluginData.featuresContainer.children(options.itemTag).first().css("borderLeftWidth") != "medium") {
                    pluginData.borderWidth = parseInt(pluginData.featuresContainer.children(options.itemTag).first().css("borderLeftWidth"))*2;
                }

                // Place all the features in a center hidden position to start off
                pluginData.featuresContainer
                    // Have to make the container relative positioning
                    .children(options.itemTag).each(function () {
                ...
                pluginData.featuresContainer.find(options.title)
                    .hide();
            }
             ...
             */
            function animateFeature($feature, direction, callback)
            {
                        ...
                        function () {
                            ...
                            if (options.counterStyle == 1 || options.counterStyle == 2) {
                                if (newPosition == 1) {
                                    ...
                                    var newCenterItemNum = pluginData.featuresContainer.children(options.itemTag).index($feature) + 1;
            ...
            function move(direction)
            {
                ...
                animateFeature($newCenter, direction, function(){
            ...
            pluginData.featuresContainer.children(options.itemTag)
                .click(function () {
